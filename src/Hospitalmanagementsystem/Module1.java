...
public class Module1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String d = ill.getSelectedItem().toString();
        String s = doctor.getSelectedItem().toString();
        ...
        String sql = "insert into patient1 "
			+ " (pname ,fname,Cnic,doctor,ill,Bloodgroup)" + " values (?, ?, ?,?,?,?)";
